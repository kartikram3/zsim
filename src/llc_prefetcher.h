...
#ifndef LLC_PREFETCHER_H_
#define LLC_PREFETCHER_H_
 ...
 */
class llc_StreamPrefetcher : public BaseCache {
    private:
        struct Entry {
    ...
    public:
        explicit llc_StreamPrefetcher(const g_string& _name) : timestamp(0), name(_name) {}

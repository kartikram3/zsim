...
#ifndef TIMING_CACHE_KARTIK_H_
#define TIMING_CACHE_KARTIK_H_
...
class TimingCacheKartik : public Cache {
    private:
    ...
    public:
        TimingCacheKartik(uint32_t _numLines, CC* _cc, CacheArray* _array, ReplPolicy* _rp, uint32_t _accLat, uint32_t _invLat, uint32_t mshrs,
